...
namespace test {
	...
	public class TableTester {
		...
		public void TestCompare() {
			...
			diff = t1.Compare(t2, new TestCompareConfig());
			...
			//test delete
			diff = t2.Compare(t1, new TestCompareConfig());
			Assert.IsTrue(diff.IsDiff);
			...
			Console.Write(t1.Compare(t2, new TestCompareConfig()).Script());

			Console.WriteLine("--- migrate down ---");
			Console.Write(t2.Compare(t1, new TestCompareConfig()).Script());
		}
